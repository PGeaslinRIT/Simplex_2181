...
namespace Simplex
{
	...
	public:
		...
		*/
		...
		/*
		USAGE: Sets this octant's spatial variables
		ARGUMENTS: 
		- vector3 a_v3Center -> center point of octant
		- float a_fSize -> length of octant's side
		OUTPUT: ---*/
		void SetSizePos(vector3 a_v3Center, float a_fSize);
		/*
		...
		*/
		...
		ARGUMENTS: a_nOctantCount -> Number of Octants currently
		OUTPUT: ---
		*/
		uint GetOctantCount();
