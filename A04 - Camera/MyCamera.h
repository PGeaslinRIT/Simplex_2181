...
namespace Simplex
{
	...
	public:
		...
		*/
		...
		/*
		USAGE: rotates the camera by an angle horizontally
		ARGUMENTS: float a_fAngle = 0.0f -> angle to rotate
		OUTPUT: ---
		*/
		void RotateHorizontally(float a_fAngle = 0.0f);
		/*
		USAGE: rotates the camera by an angle horizontally
		ARGUMENTS: float a_fAngle = 0.0f -> angle to rotate
		OUTPUT: ---
		*/
		void RotateVertically(float a_fAngle = 0.0f);
	};
