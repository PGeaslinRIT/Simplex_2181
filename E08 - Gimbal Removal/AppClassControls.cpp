...
#pragma region Camera Position
	...
	{
		quaternion qTemp = glm::angleAxis(m_RotationAngle, vector3(1.0f, 0.0f, 0.0f));
		m_qOrientation = m_qOrientation * qTemp;
	}
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::Y))
	{
		quaternion qTemp = glm::angleAxis(m_RotationAngle, vector3(0.0f, 1.0f, 0.0f));
		m_qOrientation = m_qOrientation * qTemp;
	}
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::Z))
	{
		quaternion qTemp = glm::angleAxis(m_RotationAngle, vector3(0.0f, 0.0f, 1.0f));
		m_qOrientation = m_qOrientation * qTemp;
	}
